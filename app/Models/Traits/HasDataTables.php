...
trait HasDataTables
{
  ...
  {
    $operators = [
      'equals'   => (object)['operator' => '=',  'value' => $value],
      'contains' => (object)['operator' => 'like', 'value' => '%' . $value . '%'],
      'startsWith' => (object)['operator' => 'like', 'value' => $value . '%'],
      'endsWith' => (object)['operator' => 'like', 'value' => '%' . $value],
      'gte'      => (object)['operator' => '>=', 'value' => $value],
      'lte'      => (object)['operator' => '<=', 'value' => $value],
      'between'  => (object)['operator' => 'between', 'value' => $value],
      'isAnyOf'  => (object)['operator' => 'in', 'value' => explode(',', $value)],
      'isEmpty'  => (object)['operator' => '=', 'value' => '', 'null' => true],
      'isNotEmpty' => (object)['operator' => '<>', 'value' => '', 'null' => false],
    ];
